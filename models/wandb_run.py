...
if __name__ == "__main__":
    #print("Command line params from wandb:\n", sys.argv)
    # sys.argv = [
    #    'models/wandb_run.py',
    #    '--local_config_file=/Users/dhruv/UnsyncedDocuments/IESL/kb_completion/models/configs/default_training_with_rank_validation_with_wandb_log.json',
    #    '--overrides.dataset_reader.number_negative_samples=1',
    #    '--overrides.model.softbox_temp=47.4670154684072',
    #    '--overrides.trainer.optimizer.lr=0.022811793349398136',
    #    '--subcommand=train'
    # ]
    setup_wandb()
    logger.debug("wandb.run.tags:{}".format(wandb.run.tags))
